window.addEventListener('load', async  () => {
    ...
    const modalOpen = (custom = null) => {
        ...
        message = null;
        if (custom !== null) {
            message = document.getElementById('orderNotificationLoadingModalContainerHeader').innerHTML;
            document.getElementById('orderNotificationLoadingModalContainerHeader').innerHTML = custom;
        }
        modal.classList.add(modalActiveClass);
        return {'modal': modal, 'modalActiveClass': modalActiveClass, 'message':message}
    }
